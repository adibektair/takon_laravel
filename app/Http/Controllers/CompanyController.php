...
class CompanyController extends Controller
{
    ...
    public function getServices(){
        ...
        $s = DataTables::of($services)->addColumn('checkbox', function ($service) {
            return '<a href="/share-services?id=' . $service->id .'"><button class="btn btn-success">Поделиться</button></a> <a href="/mobile_users"><button class="btn btn-outline-success">Раздать</button></a>';
        })->make();
        return $s;
    }
