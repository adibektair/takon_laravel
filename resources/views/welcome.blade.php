...
{{--                </button>--}}
        ...
        <div class="middle">
            ...
            <div class="midRight">
                <div class="lozung">
                    Комплексная платформа, где размещены оцифрованные товары, реализуемые талонами и купонами
                </div>
                <div class="pltImg">
                    <div class="pltIc">
    ...
    <div class="body" style="margin-top: 3em; margin-left: 1em; margin-bottom: 10em;">
        <div class="body-top">
...
{{--                    </p>--}}
        ...
        <div class="body-third">
            ...
            <div class="body-third-div-bottom">
                <div class="body-third-div-bottom-left">
                    ...
                    <p>
                        На нашей платформе люди могут мгновенно приобрести идеальный вариант предложения товаров и услуг.
                    </p>
                    <p>
            ...
            <div class="body-fourth-top">
                ...
                <div class="body-fourth-divs">
                    <div class="body-fourth-divs-inner">
                        ...
                        <p>
                            Высокая скорость работы приложения при покупке и реализации таконов.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="body-fifth">
            ...
            <div class="body-fifth-right">
                <img src="img/samsung_4.png" alt="" width="700" >
            </div>
        </div>
